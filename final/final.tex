...
\begin{tabular}{ll}
  Mom:     & \orth{Timirt endEt new?} \\
  Daughter:  & \orth{Timirt arIf new.} \\
  Mom:     & \orth{Yemitiwejiw astemari alesh?} \\
  Daughter:  & \orth{YenE math astemari des yilal. Hisab lai betam yiredengal.} \\
  Mom:     & \orth{Kesat min tadirgyalesh?} \\
  Daughter:  & \orth{Kesat lay, igir kwas ichawetalew.} \\
  Mom:     & \orth{Timirtibatish betam des yilal.} \\
\end{tabular}

\begin{exe}
\ex \gll \orth{timirt} \orth{indEt} \orth{new?} \\
...
\ex \gll \orth{yemiti-wejiw} \orth{astemarI} \orth{ale-h}? \\
\textsc{2f}-favorite teacher exist\textbackslash\textsc{3m}\\
...
\ex \gll \orth{timirtibEt-ish} \orth{bet'am} \orth{des} \orth{yIlal} \\
