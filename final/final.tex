...
\begin{exe}
  ...
  \ex\label{ex:group2-p}
    \gll \orth{tEN-u} \\
    sleep-2P.IMP \\
    \trans `sleep! (pl)'

  \ex\label{ex:group2-h}
    \gll \orth{inni-tENa} \\
    sleep-2H.IMP \\
    \trans `let's sleep!'

  \ex\label{ex:group1-m} \gll 
    \orth{ambib-$\emptyset$} \\
    read-2M.IMP \\
    \trans `read! (to a man)'

  \ex\label{ex:group1-f} \gll 
    \orth{ambib-I} \\
    read-2F.IMP \\
    \trans `read! (to a woman)'

  \ex\label{ex:group1-p} \gll 
    \orth{ambib-u} \\
    read-2P.IMP \\
    \trans `read! (pl)'

  \ex\label{ex:group1-h} \gll 
    \orth{in-ambib} \\
    read-2H.IMP \\
    \trans `let's read'
\end{exe}
...
\begin{exe}
  \ex\label{ex:neg-group1-m} \gll 
    \orth{at-ambib-$\emptyset$} \\
    read-2M.IMP \\
    \trans `don't read! (to a man)'

  \ex\label{ex:neg-group1-f} \gll 
    \orth{at-ambib-I} \\
    read-2F.IMP \\
    \trans `don't read! (to a woman)'

  \ex\label{ex:neg-group1-p} \gll 
    \orth{indat-ambib-u} \\
    read-2P.IMP \\
    \trans `don't read! (pl)'

  \ex\label{ex:neg-group1-h} \gll 
    \orth{ind-an-ambib} \\
    read-2H.IMP \\
    \trans `let's not read'
\end{exe}
...
\centering
\caption{Command affixes}
\label{tab:commands-neg-affixes}
\begin{tabular}{l|l}
  form & affix\\ \hline
  NF & \orth{at- -I}\\
  NM & \orth{at- -$\emptyset$}\\ 
