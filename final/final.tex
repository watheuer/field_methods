...
\label{tab:copula}
  \begin{tabular}{l|llll}
    ...
    \textsc{2sm} & \orth{neh} & `You (m) are'    & \orth{ay-dele-h-im} & `You (m) are not'\\
    \textsc{2sf} & \orth{nesh} & `You (f) are'   & \orth{ay-dele-sh-im} & `You (f) are not'\\
    \textsc{3sm} & \orth{new} & `He is'          & \orth{ay-dele-m} & `He is not'\\
    \textsc{3sf} & \orth{nech/n-at} & `She is'   & \orth{ay-dele-ch-im} & `She is not'\\
